...
def create_request(request):
    ...
    if request.method == "POST":
        ...
        reason_sub = request.POST.get("reason-sub")
...
def review_request_post(request, request_id):
    ...
    if request.method == "POST":
        ...
        request_form.is_reviewed = request.POST.get("review") == "on"
...
def validate_request_data(start_date, start_time, end_date, end_time, equipment_id, line_id, work_description):
    errors = []
